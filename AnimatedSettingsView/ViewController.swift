...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.settingsSelectionView1.setup(withBackgroundColor: .init(red: 229.0/255.0, green: 27.0/255.0, blue: 86.0/255.0, alpha: 1.0))
        self.settingsSelectionView2.setup(withBackgroundColor: .init(red: 0.0/255.0, green: 137.0/255.0, blue: 255.0/255.0, alpha: 1.0))
    }
