...
protocol RightDetailSettingsSelectionDelegate {
...
class RightDetailSettingsSelectionView: UIView {
    ...
    required init?(coder: NSCoder) {
        ...
        Bundle.main.loadNibNamed("RightDetailSettingsSelectionView", owner: self, options: nil)
